...
var assignmentClass = function () {
    ...
    var loaddata= function(){
        axios.get('student/assignments?pagesize=' + model.pagination.pagesize + '&skip=' + model.pagination.skip).then(function(response){
            var html = ''
                ...
                html += '<div class="col-lg-3 col-md-6 mb-4">'+
                            '<div class="card h-100">'+
                                '<div class="card-body">'+
                                    ...
                                    '<p class="card-text"> Intake : '+ item.Intake_Year_Month +'</p>'+
                                    '<p class="card-text"> Submission Time : '+ item.Submission_Time +'</p>'+
                                '</div>'+
